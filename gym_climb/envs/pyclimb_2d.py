...
class Car:
    def __init__(self, space, maps, wheel_radius = 30):
        ...
        self.shape.mass = 5
        self.body.position = (200, -200+960)
        ...
        self.human_body.position = (self.body.position.x, self.body.position.y-50)
        ...
        self.head_body.position = (self.human_body.position.x, self.human_body.position.y-30)
        ...
        self.wheel1_shape.color = (200, 200, 200, 255)
        self.wheel2_shape.friction = 1
        self.wheel2_shape.color = (200, 200, 200, 255)
    ...
    def draw_image(self, screen):
        ...
        screen.blit(rotated_face, (self.head_body.position[0] - 35, self.head_body.position[1] - 40))
...
def add_land(space, screen):
    body = pymunk.Body(body_type=pymunk.Body.STATIC)
    body.position = [float(0), float(0)]
    land = pymunk.Segment(body, [float(0), float(970)], [float(99999), float(970)], 10)
    land.friction = 1
...
def add_mountatins(space):
    ...
    for i in range(50):
        ...
        body.position = (x, -random.randint(-50, 0)+960)
        vertices = []
...
class PyClimb2D:
    def __init__(self, is_render = True):
        ...
        add_land(self.space, self.screen)
    ...
    def is_done(self):
        if self.car.check >= 111 or self.car.is_dead or self.car.total_reward < -1000:
            return True
        return False
